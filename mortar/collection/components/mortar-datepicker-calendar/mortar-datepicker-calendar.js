import { Component, h, Prop, Event, Watch, Listen, Element } from '@stencil/core';
...
export class MortarDatepicker {
            ...
            return arr.map((_r, r) => {
                ...
                return (h("div", { class: "datepicker-content-row" }, rArr.map((_c, c) => {
                    if (r === 0 && c < cm.first) {
                        ...
                        return (h("div", { class: `datepicker-content-item datepicker-content-out ${this.customClass(cm.previous.year, cm.previous.month, pD)}` },
                            h("div", { class: "datepicker-content-display" },
                                h("span", null, pD))));
                    }
                        ...
                        if (this.isAvailable(cm.year, cm.month, cd)) {
                            ...
                            return (h("div", { class: `datepicker-content-item ${cn}`, onClick: () => this.handleClickDay(cm.year, cm.month, cd) },
                                h("div", { class: "datepicker-content-display" },
                                    h("span", null, cd))));
                        }
                        else {
                            return (h("div", { class: `datepicker-content-item datepicker-content-out ${this.customClass(cm.year, cm.month, cd)}` },
                                h("div", { class: "datepicker-content-display" },
                                    h("span", null, cd))));
                        }
                    }
                        ...
                        next++;
                        return (h("div", { class: `datepicker-content-item datepicker-content-out ${this.customClass(cm.next.year, cm.next.month, next)}` },
                            h("div", { class: "datepicker-content-display" },
                                h("span", null, next))));
                    }
                })));
    ...
    renderEl() {
        return (h("div", { class: this.className() },
            this.header &&
                h("div", { class: "datepicker-selector" },
                    h("div", { class: "datepicker-select-dropdown" },
                        h("mortar-dropdown", { value: this.getMonthValue(), placeholder: this.monthPlaceholder, onItemSelect: this.handleChangeCurrentMonth }, this.getAvailableMonths())),
                    h("div", { class: "datepicker-select-dropdown" },
                        h("mortar-dropdown", { value: this.getYearValue(), placeholder: this.yearPlaceholder, onItemSelect: this.handleChangeCurrentYear }, this.getAvailableYears())),
                    h("div", { class: "datepicker-select-clear" },
                        h("button", { onClick: this.handleClear },
                            h("mortar-icon", { kind: "close", arialabel: "close" })))),
            h("div", { class: "datepicker-header" },
                h("div", { class: "datepicker-header-previous" },
                    h("button", { onClick: () => this.handleChangeMonth(-1) },
                        h("mortar-icon", { kind: "back", arialabel: "Previous Month" }))),
                h("div", { class: "datepicker-header-display" },
                    h("span", null, this.getCurrentMonth())),
                h("div", { class: "datepicker-header-next" },
                    h("button", { onClick: () => this.handleChangeMonth(1) },
                        h("mortar-icon", { kind: "next", arialabel: "Next Month" })))),
            h("div", { class: "datepicker-body", tabindex: "0", onFocus: this.handleCalendarFocus, onBlur: this.handleCalendarBlur },
                h("div", { class: "datepicker-days" }, this.days.map((v) => {
                    return (h("div", { class: "datepicker-day" },
                        h("div", { class: "datepicker-day-display" },
                            h("span", null, v))));
                })),
                h("div", { class: "datepicker-content" }, this.getCalendarDays()))));
    }
    static get is() { return "mortar-datepicker-calendar"; }
    static get properties() { return {
        ...
        "customClass": {
            ...
            "mutable": false,
            "complexType": {
                "original": "(_year: any, _month: any, _date: any) => string",
                "resolved": "(_year: any, _month: any, _date: any) => string",
                "references": {}
            },
            "required": false,
            "optional": false,
